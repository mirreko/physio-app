<template>
    <div class="p-6 bg-background rounded-2xl">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div
          ...
          :key="patient._id"
          :class="['flex items-center border rounded-2xl p-4 cursor-pointer hover:bg-gray-100', { 'bg-blue-100 border-blue-400': selectedPatient && selectedPatient._id === patient._id }]"
  ...
  export default {
    ...
    methods: {
      ...
      handleSelectPatient(patient) { // Hier den Namen der Methode anpassen
